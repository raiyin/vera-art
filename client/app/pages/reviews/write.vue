    ...
    <div class="review-write-page">
        <div class="review-write-page__container">
            <div class="review-write-page__header">
                <h1 class="review-write-page__title">{{ $t('review.write.title') }}</h1>
            ...
            <div v-if="product" class="review-write-page__product">
                <div class="review-write-page__product-image">
                    ...
                    />
                    <div v-else class="review-write-page__product-placeholder">
                        {{ productTypeIcon }}
                    </div>
                </div>
                <div class="review-write-page__product-info">
                    <h2 class="review-write-page__product-title">{{ productTitle }}</h2>
            ...
            <div v-if="error" class="review-write-page__error">
                {{ error }}
            </div>

            <div v-if="!hasPurchase" class="review-write-page__warning">
