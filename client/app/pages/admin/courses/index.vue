<template>
    <div class="admin-page">
        ...
        <div class="admin-page__breadcrumbs">
            ...
            <span class="admin-page__breadcrumbs-current">Курсы</span>
        </div>
                        ...
                        >
                            ...
                            <td class="admin-page__cell admin-page__cell--actions">
                                <div class="admin-page__actions">
                                    <UTooltip text="Управление уроками">
                                        <UButton
                                            icon="i-lucide-list-checks"
                                            color="neutral"
                                            variant="ghost"
                                            size="sm"
                                            :to="`/admin/lessons?product_id=${item.id}`"
                                        />
                                    </UTooltip>
            ...
            <UCard>
                <template #header>
                    <h3 class="text-lg font-semibold">
                        {{ deletingSingle ? 'Удаление курса' : 'Удаление курсов' }}
                    </h3>
                </template>
