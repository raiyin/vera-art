...
<template>
  ...
  >
    ...
    <p>
      ...
      3d-дизайнер и просто хороший человек. Я рада вас видеть на своём сайте.
      Здесь вы можете познакомиться с моим творчеством, работами, достижениями,
      а также узнать о новостях из моей профессиональной жизни.
    </p>
    <p>
      Буду рада, если вам понравится какая-либо из моих работ, и тем более, если
      решите её купить или сделать заказ на картину. Надеюсь вы судовольствием
      проведёте время здесь и захотите посещать мой сайт снова и снова. Следите
      за обновлениями.
    </p>
  </div>
  ...
  <div style="position: relative; background-color: #282e34">
    ...
    >
      <p>
        Я убеждена, что человек должен не зарывать свои таланты в землю, а
        приумножать их. Поэтому стараюсь постоянно развиваться сама и передавать
        накоплненные знания своим детям и ученикам.
      </p>
    </div>
  </div>
