...
<template>
  ...
  >
    ...
    <p>
      ...
      решите её купить или сделать заказ на картину. Надеюсь вы с удовольствием
  ...
  <div style="position: relative; background-color: #282e34">
    ...
    >
      <p>
        Я убеждена, что человек должен не зарывать свои таланты, а приумножать
        их. Поэтому стараюсь постоянно развиваться сама и передавать
